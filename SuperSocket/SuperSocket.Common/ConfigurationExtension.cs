...
namespace SuperSocket.Common
{
    ...
    public static class ConfigurationExtension
    {
        ...
        /// <summary>
        /// get the value from namevalue collection by key
        /// </summary>
        ...
        public static void Deserialize<TElement>(this TElement section, XmlReader reader)where TElement:ConfigurationElement
        {
        ...
        public static TConfig DeserializeChildConfig<TConfig>(string childConfig) where TConfig:ConfigurationElement,new ()
        {
            ...
            using (XmlReader reader = new XmlTextReader(new StringReader(childConfig)))
            {
        ...
        /// <summary>
        /// Get the child config
        /// </summary>
        /// <typeparam name="TConfig">The type of the config</typeparam>
        /// <param name="childElements">The child elements</param>
        /// <param name="childConfigName">Name of the child config</param>
        /// <returns></returns>
        public static TConfig GetChildConfig<TConfig>(this NameValueCollection childElements, string childConfigName) where TConfig:ConfigurationElement,new()
        {
        ...
        public static void LoadFrom(this ConfigurationElement configElement, object source)
        {
            ...
            {
                throw new Exception("Can't find expected property 'item' from the type ''");
            }
